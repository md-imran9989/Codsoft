...
class TodoListApp:
    def __init__(self, root):
        ...
        add_button = tk.Button(root, text="Add Task", command=self.add_task, font=('Arial', 12), bg="green", fg="#ecf0f1")  # Set button colors
        add_button.grid(row=0, column=1, padx=10, pady=10)

        self.task_listbox = tk.Listbox(root, width=40, height=10, font=('Arial', 12), bg="#ecf0f1", fg="#2c3e50", selectbackground="gold")  # Set listbox colors
        ...
        complete_button = tk.Button(root, text="Complete Task", command=self.complete_task, font=('Arial', 12), bg="blue", fg="#ecf0f1")  # Set button colors
